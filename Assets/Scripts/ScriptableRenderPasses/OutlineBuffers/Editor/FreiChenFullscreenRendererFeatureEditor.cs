...
[CustomEditor(typeof(FreiChenFullScreenRendererFeatureEditor))]
// ReSharper disable once CheckNamespace
public class FreiChenFullScreenRendererFeatureEditor : Editor
{
    private FreiChenComputeFeature m_AffectedFeature;
    ...
    public override void OnInspectorGUI()
    {
        ...
        m_AffectedFeature = target as FreiChenComputeFeature;
    ...
    private List<string> GetPassIndexStringEntries(FreiChenComputeFeature component)
    {
