...
//
//  https://github.com/TheRealMJP/Shadows/blob/master/Shadows/SampleFramework11/Shaders/Conversion.hlsl
//
...
{
    uint2 result = 0;
    result.x = f32tof16(val.x) | f32tof16(val.y) << 16;
    result.y = f32tof16(val.z) | f32tof16(val.w) << 16;
...
{
    const uint result = f32tof16(val.x) | f32tof16(val.y) << 16;
