Shader "GeneratedFromGraph-StdDeviation"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Graph Includes
            #include "Assets/Resources/Utilities/MathUtils/stdDev_SGFunctions.hlsl"
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                const float2 uv0 = IN.uv0.xy;
                // const int2 coord = floor(uv0 * _ScreenSize.xy);

                float4 std = StandardDeviation_f32(_BlitTexture, uv0);

                surface.BaseColor = std.rgb;
                surface.Alpha = 1;
                return surface;
            }
