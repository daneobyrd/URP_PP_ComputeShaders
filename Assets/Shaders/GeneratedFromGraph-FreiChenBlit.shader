Shader "Shader Graphs/FreiChenBlit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        SAMPLER(sampler_FreiChenTexture);
        float4 _FreiChenTexture_TexelSize;
        float _FlipY;
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float4 _URPSampleBuffer_ccf477502ea3450e9c91e328dc192b4f_Output_2 = Unity_Universal_SampleBuffer_BlitSource_float(float4(IN.NDCPosition.xy, 0, 0).xy);
            float3 _Swizzle_597794fe6c914fdabb997154d7ae4fbd_Out_1 = _URPSampleBuffer_ccf477502ea3450e9c91e328dc192b4f_Output_2.xyz;
            surface.BaseColor = _Swizzle_597794fe6c914fdabb997154d7ae4fbd_Out_1;
            surface.Alpha = 1;
            return surface;
        }
